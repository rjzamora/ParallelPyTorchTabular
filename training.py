...
parser.add_argument('--batch-size', type=int, default=80960,
...
parser.add_argument('--hvd', action='store_true', default=False,
...
# Print logs on the first worker only.
verbose = 1 if myrank == 0 else 0

# Write TensorBoard logs on first worker.
...
## Note: If serial - Can use Adam optimizer
if args.adam:
